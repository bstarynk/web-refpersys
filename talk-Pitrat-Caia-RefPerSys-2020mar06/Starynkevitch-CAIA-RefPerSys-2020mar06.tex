...
%%   is practically futile (billions of lines in a Linux desktop ; see
%%   also
...
%%     locality, disk, MMU) \textcolor{red}{\textbf{and
...
%%   \end{itemize}
 ...
 From wikipedia \href{https://en.wikipedia.org/wiki/Semantic_network}{Semantic network} 

 \bigskip

 \begin{center}
 \includegraphics[width=0.60\textwidth]{Semantic-Net}
 \end{center}
 
 \bigskip
 
$\Rightarrow$ Flexible frame represention
 \end{frame}
